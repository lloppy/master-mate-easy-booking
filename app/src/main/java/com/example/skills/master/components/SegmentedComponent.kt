...
private val TRACK_COLOR = Color.Black
...
private val SEGMENT_PADDING = 15.dp

/** Alpha to use to indicate pressed state when unselected segments are pressed. */
private const val PRESSED_UNSELECTED_ALPHA = 1f
...
fun SegmentText(text: String, isSelected: Boolean) {
    ...
    Text(text, maxLines = 1, overflow = Ellipsis, color = currentColor)
}
